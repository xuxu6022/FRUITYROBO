...
<template>
  ...
  <div style="position: relative; width: 100%;margin-top: 64px;">
    ...
    <div style="position: absolute; top: 75%; left: 50%; transform: translate(-50%, -50%); width: 50%; text-align: center;">
      <p style="font-size: 56px; color: #274C5B; font-weight: bold; margin: 0; text-align: center; border: 2px solid rgba(255, 255, 255, 0.5);background-color: rgba(255, 255, 255, 0.5);">
  COMMENT
</p>
